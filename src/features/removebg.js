...
import { downloadMedia, findMedia, isOwner, reply } from '../utils.js';
...
// .removebg - khusus owner bot. Reply foto (atau upload foto dengan caption .removebg).
export default async function removebg(sock, m, args, sessionDir) {
  if (!isOwner(sock, m, sessionDir)) {
    return reply(sock, m, 'Fitur ini hanya untuk owner.');
  }
